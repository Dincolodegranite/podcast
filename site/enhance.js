...
/* ── World land grid ─────────────────────────────────────────────
   72 x 26 cells, equirectangular, lon -180..180 (5°/col), lat 75..-55 (5°/row).
   '#' = land dot. Deliberately coarse — renders as a stylized dot-matrix map. */
var GRID = [
'............##########..#######.........#######################.........',
'......#######################...........#######################.........',
'....#########################..##.......#######################.........',
...
function initMap(){
  ...
  function draw(now){
    ...
    var cw = W / GRID_COLS, ch = H / GRID_ROWS, r = Math.max(1, cw * 0.24);
    ctx.fillStyle = 'rgba(201,162,90,.15)';
    for(var row = 0; row < GRID_ROWS; row++){
      var line = GRID[row];
      for(var col = 0; col < GRID_COLS; col++){
        if(line.charAt(col) === '#' || line.charAt(col) === '*'){
          ctx.beginPath();
          ctx.arc(col * cw + cw / 2, row * ch + ch / 2, r, 0, 6.2832);
          ctx.fill();
        }
      }
    }
    ...
    if(arc){
      ...
      ctx.arc(p1[0], p1[1], r * 1.7, 0, 6.2832); ctx.fill();
